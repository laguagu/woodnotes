...
export const SmoothLoader = () => (
  <div className="flex items-center justify-center">
    <div className="mr-2 w-5 h-5 border-2 border-gray-100 border-t-gray-600 rounded-full animate-spin"></div>
  </div>
);
  ...
  return (
    <div>
      <div className="flex flex-col space-y-8">
        <Skeleton className="h-72 min-w-[350px] sm:h-72 md:h-80 md:w-[520px] rounded-xl bg-gray-100 shadow-md" />
        <div className="flex space-x-4 justify-center">
          <Skeleton className="h-8 w-32 sm:w-32 md:w-40 lg:w-48 bg-slate-200" />
          <Skeleton className="h-8 w-28 sm:w-28 md:w-36 lg:w-44 bg-slate-200" />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="flex flex-col space-y-3">
        <Skeleton className="h-80 w-[310px] sm:min-w-[375px] rounded-xl bg-gray-100 shadow-md" />
